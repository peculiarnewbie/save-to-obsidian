...
<div class="flex flex-col gap-4 h-[3000px] w-full p-4">
	<div class="w-20 h-20 bg-gray-500 rounded-md">
		<p>wha</p>
		<div class="w-8 h-6 bg-white">nuu</div>
	</div>
	<div class=" rounded-3xl h-96 w-96 overflow-hidden">
		<img
			class="h-full w-full"
			src="https://e.snmc.io/i/600/w/291a2a8451de99ede908023514823338/10297048/paramore-this-is-why-Cover-Art.jpg"
			alt="test"
		/>
	</div>
	<p class="text-white">{"<><><as></as>"}</p>
	<p class="text-white">
